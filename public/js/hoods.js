$(document).ready(function() {
  ...
  function createHoodRow(hoodData) {
    ...
    newTr.append("<td><a href='/blog?hood_id=" + hoodData.id + "'>Go to Posts</a></td>");
    newTr.append("<td><a href='/cms?hood_id=" + hoodData.id + "'>Create a Post</a></td>");
  ...
  // A function for rendering the list of Neighborhoods to the page
